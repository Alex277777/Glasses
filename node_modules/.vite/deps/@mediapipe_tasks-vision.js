...
function e(e2) {
  t: {
    for (var n2 = ["CLOSURE_FLAGS"], r2 = t, i2 = 0; i2 < n2.length; i2++)
      if (null == (r2 = r2[n2[i2]])) {
        n2 = null;
        break t;
      }
...
var B = class {
  constructor(t2, e2) {
    if (U(e2), this.g = t2, null != t2 && 0 === t2.length)
...
function X(t2) {
  if ("string" == typeof t2)
    return { buffer: R(t2), P: false };
  if (Array.isArray(t2))
    return { buffer: new Uint8Array(t2), P: false };
  if (t2.constructor === Uint8Array)
    return { buffer: t2, P: false };
  if (t2.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t2), P: false };
  if (t2.constructor === B)
    return { buffer: N(t2) || C(), P: true };
  if (t2 instanceof Uint8Array)
    return { buffer: new Uint8Array(t2.buffer, t2.byteOffset, t2.byteLength), P: false };
...
function Q(t2, e2) {
  if (t2 >>>= 0, 2097151 >= (e2 >>>= 0))
    ...
    H() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, 1e7 <= t2 && (n2 += Math.floor(t2 / 1e7), t2 %= 1e7), 1e7 <= n2 && (e2 += Math.floor(n2 / 1e7), n2 %= 1e7), n2 = e2 + tt(n2) + tt(t2));
  return n2;
}
function tt(t2) {
...
function nt(t2) {
  if (16 > t2.length)
    ...
    t2 = BigInt(t2), K = Number(t2 & BigInt(4294967295)) >>> 0, Y = Number(t2 >> BigInt(32) & BigInt(4294967295));
  else {
    const e2 = +("-" === t2[0]);
    Y = K = 0;
    const n2 = t2.length;
...
function ae(t2, e2, n2) {
  if (null != t2) {
    if ("string" == typeof t2)
      ...
      if (M(t2))
        t2 = t2.length ? new B(n2 ? t2 : new Uint8Array(t2), O) : D();
      else {
        if (!e2)
          throw Error();
        t2 = void 0;
...
function Ce(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.X === re)
    return t2;
  if (!Array.isArray(t2))
    return n2 ? 2 & r2 ? (t2 = e2[Xt]) ? e2 = t2 : (Zt((t2 = new e2()).s), e2 = e2[Xt] = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = $t(t2);
...
function Qe(t2, e2, n2, r2, i2) {
  if (null != t2) {
    if (Array.isArray(t2))
      t2 = he(t2, void 0, 0) ? void 0 : i2 && 2 & $t(t2) ? t2 : tn(t2, e2, n2, void 0 !== r2, i2);
    else if (oe(t2)) {
      const s2 = {};
      for (let o2 in t2)
        s2[o2] = Qe(t2[o2], e2, n2, r2, i2);
      t2 = s2;
    } else
      t2 = e2(t2, r2);
    return t2;
...
function un(t2, e2, n2, r2) {
  if (!(0 > (e2 = r2 + (+!!(512 & e2) - 1)) || e2 >= t2.length || e2 >= n2))
    return t2[e2];
}
...
function Tn(t2, e2, n2) {
  {
    ...
    if (ue(h2), null == n2)
      ...
      if ((r2 = !o2) && (r2 = false), hn(t2, i2))
        for (i2 = 21, o2 && (n2 = Gt(n2), s2 = 0, i2 = Un(i2 = In(i2, h2), h2, true)), t2 = 0; t2 < n2.length; t2++)
          n2[t2] = Re(n2[t2]);
...
function Ln(t2, e2, n2, r2) {
  ...
  let o2;
  if (null != s2 && s2.X === re)
    return (e2 = an(s2)) !== s2 && fn(t2, i2, n2, e2, r2), e2.s;
  if (Array.isArray(s2)) {
    const t3 = $t(s2);
...
function Mn(t2, e2, n2, r2, i2, s2) {
  ...
  if (s2 && !(8 & h2 || !a2.length && (1 === o2 || 4 === o2 && 32 & h2))) {
    for (En(h2) && (a2 = Gt(a2), h2 = In(h2, e2), e2 = fn(t2, e2, r2, a2)), n2 = a2, s2 = h2, u2 = 0; u2 < n2.length; u2++)
      (h2 = n2[u2]) !== (l2 = an(h2)) && (n2[u2] = l2);
...
function Kn(t2, e2, n2) {
  ...
  for (h2 = +!!(512 & i2) - 1; 0 < t2 && (n2 = e2[c2 = t2 - 1], c2 -= h2, null == n2 || he(n2, r2, c2) || se(n2) && 0 === n2.size); t2--)
    o2 = true;
...
function Er(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2)
      i2 = +t3, Number.isNaN(i2) || null != (s2 = r2[t3]) && (a2 = vr(n2, i2)) && a2(e2, s2, i2);
  }
  if (t2 = de ? t2[de] : void 0)
    for (Ct(e2, e2.g.end()), n2 = 0; n2 < t2.length; n2++)
      Ct(e2, N(t2[n2]) || C());
}
function wr(t2, e2) {
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        Array.isArray(n3) ? s2 = !!(2 & $t(n3)) : n3 = [];
      if (i2) {
        if (!n3.length)
          return Ze();
        s2 || (s2 = true, Zt(n3));
      } else
        s2 && (s2 = false, n3 = wn(n3));
...
function Oo(t2) {
  ...
  if ((e2 = (_a2 = Rn(t2, Qi, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: Nn(e2, 1) ?? 0, originY: Nn(e2, 2) ?? 0, width: Nn(e2, 3) ?? 0, height: Nn(e2, 4) ?? 0, angle: 0 }), (_b = Rn(t2, Qi, 4)) == null ? void 0 : _b.g().length)
    for (const e3 of Rn(t2, Qi, 4).g())
      s2.keypoints.push({ x: gn(e3, 1) ?? 0, y: gn(e3, 2) ?? 0, score: gn(e3, 4) ?? 0, label: Pe(cn(e3, 3)) ?? "" });
  return s2;
}
function Io(t2) {
  const e2 = [];
  for (const n2 of Pn(t2, as, 1))
    e2.push({ x: Gn(n2, 1) ?? 0, y: Gn(n2, 2) ?? 0, z: Gn(n2, 3) ?? 0, visibility: Gn(n2, 4) ?? 0 });
  return e2;
}
function Uo(t2) {
  const e2 = [];
  for (const n2 of Pn(t2, rs, 1))
    e2.push({ x: Gn(n2, 1) ?? 0, y: Gn(n2, 2) ?? 0, z: Gn(n2, 3) ?? 0, visibility: Gn(n2, 4) ?? 0 });
  return e2;
}
function Do(t2) {
...
async function Zo(t2, e2, n2, r2) {
  return t2 = await (async (t3, e3, n3, r3, i2) => {
    if (e3 && await Wo(e3), !self.ModuleFactory)
      throw Error("ModuleFactory not set.");
    if (n3 && (await Wo(n3), !self.ModuleFactory))
      throw Error("ModuleFactory not set.");
...
function ta(t2) {
  try {
    ...
    if (1 === e2)
      throw Error(t2.K[0].message);
    if (1 < e2)
      throw Error("Encountered multiple errors: " + t2.K.map((t3) => t3.message).join(", "));
  } finally {
    t2.K = [];
  }
}
...
var sa = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c = Rn(this.baseOptions, Ms, 1)) == null ? void 0 : _c.g()) || ((_d = Rn(this.baseOptions, Ms, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
function ha(t2, e2, n2) {
  const r2 = t2.g;
  if (n2 = oa(r2.createShader(n2), "Failed to create WebGL shader"), r2.shaderSource(n2, e2), r2.compileShader(n2), !r2.getShaderParameter(n2, r2.COMPILE_STATUS))
...
var ga = class {
  ...
  m() {
    const t2 = this.g;
    if (this.h = oa(t2.createProgram(), "Failed to create WebGL program"), this.ba = ha(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t2.VERTEX_SHADER), this.aa = ha(this, this.H(), t2.FRAGMENT_SHADER), t2.linkProgram(this.h), !t2.getProgramParameter(this.h, t2.LINK_STATUS))
...
var Na = class {
  ...
  Aa(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2)
        n2.fillStyle = Ma(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = Ma(e2.color, { index: i2, from: s2 }), n2.lineWidth = Ma(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, Ma(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  za(t2, e2, n2) {
...
function th(t2, e2, n2, r2) {
  if (t2.V) {
    ...
    if (n2 == null ? void 0 : n2.regionOfInterest) {
      ...
      Hn(s2, 1, 0.5), Hn(s2, 2, 0.5), Hn(s2, 4, 1), Hn(s2, 3, 1);
...
var ih = class extends sa {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Vn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas)
...
var sh = class extends ih {
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect_in"), Si(n2, "DETECTIONS:detections"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3)
        t3 = ns(e4), this.j.detections.push(Oo(t3));
      ea(this, e3);
...
var yh = class extends ih {
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = us(e4), this.u.faceLandmarks.push(Io(t3));
      ea(this, e3);
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = Wi(e4), this.u.faceBlendshapes.push(Co(t3.g() ?? []));
      ea(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = Rn(Gs(e4), ls, 2)) && this.u.facialTransformationMatrixes.push({ rows: Bn(Nn(t3, 1), 0) ?? 0, columns: Bn(Nn(t3, 2), 0) ?? 0, data: yn(t3, 3, ve).slice() ?? [] });
      ea(this, e3);
...
var _h = class extends ih {
  ...
  Pa(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, eh(this, t2, r2 ?? {}), !this.h)
      return this.u;
  }
  m() {
    var t2 = new Di();
...
function Th(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != Nn(n3, 1) ? Bn(Nn(n3, 1), 0) : -1, t2.push({ score: Gn(n3, 2) ?? 0, index: r2, categoryName: jn(n3, 3) ?? "", displayName: jn(n3, 4) ?? "" });
    n2.push(t2);
  }
  return n2;
}
var Ah = class extends ih {
  ...
  o(t2) {
    ...
    if (Xn(this.h, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Hn(this.h, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Hn(this.A, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Hn(this.u, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = Rn(this.j, $s, 3)) == null ? void 0 : _b.g());
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "HAND_GESTURES:hand_gestures"), Si(n2, "LANDMARKS:hand_landmarks"), Si(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Si(n2, "HANDEDNESS:handedness"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) {
        t3 = us(e4);
        const n3 = [];
        for (const e5 of Pn(t3, as, 1))
          n3.push({ x: Gn(e5, 1) ?? 0, y: Gn(e5, 2) ?? 0, z: Gn(e5, 3) ?? 0, visibility: Gn(e5, 4) ?? 0 });
...
var kh = class extends ih {
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "LANDMARKS:hand_landmarks"), Si(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Si(n2, "HANDEDNESS:handedness"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = us(e4), this.landmarks.push(Io(t3));
      ea(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      ea(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = os(e4), this.worldLandmarks.push(Uo(t3));
      ea(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      ea(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: Gn(e5, 2) ?? 0, index: Bn(Nn(e5, 1), 0) ?? -1, categoryName: jn(e5, 3) ?? "", displayName: jn(e5, 4) ?? "" });
        i2.push(n4);
      }
...
var Rh = class extends ih {
  ...
  m() {
    ...
    An(n2, 1, Me("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t3, e3) {
      if (null != e3)
        if (Array.isArray(e3))
          dn(t3, 2, tn(e3, nn, void 0, void 0, false));
        else {
          if (!("string" == typeof e3 || e3 instanceof B || M(e3)))
    ...
    ki(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), Oi(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = bs(t3), this.embeddings = function(t4) {
        return { embeddings: Pn(t4, Es, 1).map((t5) => {
          ...
          if (void 0 !== Fn(t5, _s, xn(t5, 1)))
            t5 = yn(t5 = Rn(t5, _s, xn(t5, 1)), 1, ve), e4.floatEmbedding = t5.slice();
          else {
...
Ph.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding)
    t2 = No(t2.floatEmbedding, e2.floatEmbedding);
  else {
...
var rc = class extends ih {
  ...
  ga(t2, e2, n2, r2) {
    ...
    const s2 = new Zh();
    var o2 = new Nh();
    if (Xn(o2, 1, 255), Cn(s2, 0, 12, o2), e2.keypoint && e2.scribble)
    ...
    if (e2.keypoint) {
      ...
      for (a2 of (o2 = new Jh(), e2.scribble))
        Vn(e2 = new $h(), 3, true), Hn(e2, 1, a2.x), Hn(e2, 2, a2.y), Dn(o2, 1, $h, e2);
      On(s2, 15, Qh, o2);
    }
